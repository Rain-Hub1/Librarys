	...
	function WindowFunction:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddDropdown(DropdownConfig)
				...
				local SearchIcon = SetProps(MakeElement("Image", "rbxassetid://96790569131548"), {
					Size = UDim2.new(0, 18, 0, 18),
					Position = UDim2.new(1, -25, 0, 11),
					ImageColor3 = Color3.fromRGB(255, 255, 255)
				})
				...
				function Dropdown:Set(Value)
					if not table.find(Dropdown.Options, Value) then
						...
						TweenService:Create(CheckIcon, TweenInfo.new(.2, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {ImageTransparency = 1, Size = UDim2.new(0, 0, 0, 0)}):Play()
						return
					end
					...
					local TextBounds = DropdownFrame.F.Selected.TextBounds.X
				...
				AddConnection(Click.MouseButton1Click, function()
					...
					if Dropdown.Toggled then
						...
						if #Dropdown.Options > MaxElements then
							targetHeight = (MaxElements * 28) + 50
						else
							targetHeight = (#Dropdown.Options * 28) + 50
						end
						
						TweenService:Create(DropdownFloat,TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Size = UDim2.new(0, 200, 0, targetHeight)}):Play()
						TweenService:Create(DropdownContainer,TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Size = UDim2.new(1, 0, 1, -50)}):Play()
					else
						TweenService:Create(DropdownFloat,TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Size = UDim2.new(0, 200, 0, 0)}):Play()
						TweenService:Create(DropdownContainer,TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Size = UDim2.new(1, 0, 0, 0)}):Play()
						wait(0.15)
				...
				AddConnection(UserInputService.InputBegan, function(input)
					if Dropdown.Toggled and (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) then
