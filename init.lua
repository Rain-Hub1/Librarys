...
function Lib:Window(Info)
    ...
    local Tab = loadModule("src/Elements/Tab.lua")
    
    -- Verificar se todos os módulos foram carregados
    if not WindowComponent or not TitleBar or not Notify or not Paragraph or not Button or not Toggle or not Tab then
